        ...
        return(
            <div className="layout-wrapper">
                ...
                <div className="contact-container">
                    ...
                    <p>If you have any comments, ideas, critiques, or you just want to say hi, don’t hesitate to send me an email at MosesCheboi254@gmail.com!</p>
                    </div>

                    <div className="contact-section">
                        <h2>Around the web</h2>
                        <ul>
                            <li><strong>Email</strong>:MosesCheboi254@gmail.com</li>
                            <li><strong>LinkedIn</strong><a href="https://linkedin.com/in/moses-cheboi">Moses Cheboi</a></li>
                            <li><strong>GitHub</strong>: <a href="https://github.com">Cheboi Moses</a></li>
